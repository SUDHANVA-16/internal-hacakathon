	...
	<header>
		<div class="container agile-banner_nav">
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
				...
				<h1><a class="navbar-brand" href="home_manager.php">SMVITM <span class="display"></span></a></h1>
...
<section class="contact py-5">
	<div class="container">
			<?php
				$man_id=$_SESSION['hostel_id'];
			?>
			<div class="mail_grid_w3l">
				<h2> Number of Students in Each Year </h2>
				<?php 
					//stored procedure

					$sql1 = "CALL SP_branch_year('year','$man_id');";
				...
				?> 
				<h2> Number of Students in Each Branch </h2>
				<?php 
