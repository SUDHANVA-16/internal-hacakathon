			...
			<header>
				<div class="container agile-banner_nav">
					<nav class="navbar navbar-expand-lg navbar-light bg-light">
						<h1><img style="padding: 5%;border-radius: 10%;" src="logo.png"></h1>
					...
					<div class="svg-wrapper">
						<svg viewBox="0 0 1400 800">
							...
							<image height='800px' width="1400px" clip-path="url(#cd-image-1)"
								xlink:href="web_home/images/1.jpg"></image>
						</svg>
					</div> <!-- .svg-wrapper -->
	...
	<footer class="py-5">
		<div class="container py-md-5">
			<div class="footer-logo mb-5 text-center">
				<a class="navbar-brand" href="https://sode-edu.in/" target="_blank">SMVITM <span class="display">
						BANTAKAL</span></a>
			</div>
